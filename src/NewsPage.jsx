...
import NewsDetailPopover from "./NewsDetailPopover";
...
function ChevronIcon({ open = false }) {
  return (
    <svg
      viewBox="0 0 16 16"
      aria-hidden="true"
      className={`icon-inline news-chevron${open ? " open" : ""}`}
    >
            ...
            <div className="news-accordion-list">
              {newsFaq.map((section, index) => {
                ...
                return (
                  <section
                    key={section.title}
                    className={`news-accordion-item${isOpen ? " open" : ""}`}
                  >
                    <button
                      type="button"
        ...
        <div className="news-main">
          <section className="news-hero-panel">
            <div className="news-hero-copy">
              ...
              <div
                className="trust-strip news-trust-strip"
          ...
          <section className="news-benefit-grid" aria-label="Program perks">
            {benefitCards.map((card) => (
              <article
                key={card.id}
                className="library-card news-benefit-card"
              ...
              >
                <div className="news-card-media">
                  <img
                    src={card.image}
                    alt={card.title}
                    className="news-benefit-bg"
                  />
                  <div className="news-card-read-cue">
                    <span>Read</span>
                    <svg
                      viewBox="0 0 16 16"
                      fill="none"
