...
const categories = [
  'All', 'Analytics', 'Developer Tools', 'Productivity', 'Marketing', 'Design', 
  'Sales', 'Customer Support', 'Finance', 'HR', 'Legal', 'Engineering', 
  'Operations', 'Security', 'Data Science', 'Machine Learning', 'AI', 'Web3', 
  'Crypto', 'E-commerce', 'Education', 'Healthcare', 'Real Estate', 'Travel', 
  'Food & Beverage', 'Entertainment', 'Gaming', 'Social', 'Music', 'Video', 
  'Photography', 'Fitness', 'Lifestyle', 'News', 'Weather', 'Utilities', 
  'Reference', 'Books', 'Business', 'Navigation'
];
                ...
                <div className="app-info">
                  ...
                  <div className="app-meta">
                    <span className="app-meta-comment">
                      <svg viewBox="0 0 24 24" aria-hidden="true" className="icon-inline small-icon">
                        <path d="M5 6.5h14v9H11l-4 3v-3H5z" />
                        <path d="M9 10.5h6" />
                      </svg>
                      <span>12</span>
                    </span>
                    <span className="app-meta-tag">{app.category || 'Analytics'}</span>
                  </div>
                </div>
              </div>
              
              <div className="app-item-right">
                <button className="upvote-button" aria-label={`Upvote ${app.name}`}>
                  <CaretUpIcon />
      ...
      <aside className="apps-sidebar">
        ...
        <div className="sidebar-widget">
          ...
          <div className="panel-chips">
            {['Developer Tools', 'Productivity', 'Data & Analytics', 'Design Tools', 'Marketing'].map(chip => (
